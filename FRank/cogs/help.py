...
help.add_field(name="@FRank top", value="Affiche les 5 personnes les plus hautes dans le classement du serveur",
               inline=False)
help.add_field(name="Il manque des commandes ?",
...
help.add_field(name="Ajoutez FRank à votre serveur !",
               ...
               inline=False)
help.set_footer(text="* Nécésite la permission \"Administrateur\" sur le serveur",
...
shelp.add_field(name="/top", value="Affiche les 5 personnes les plus hautes dans le classement du serveur",
                inline=False)
shelp.add_field(name="/role liste", value="Affiche les roles donnés lors de levels-up", inline=False)
shelp.add_field(name="/role ajouter [niveau] [role]*", value="Ajoute un role-level.", inline=False)
shelp.add_field(name="/role supprimer [niveau]*", value="Supprime un role-level.", inline=False)
shelp.add_field(name="/reset*", value="Réinitalise **tous** les stats du serveur", inline=False)
shelp.add_field(name="/del [role]*", value="Réinitalise l'xp d'une personne", inline=False)
...
class cmd(commands.Cog):
    ...
    @cog_ext.cog_slash(name="help", guild_ids=[658602051143598081], description="Affiche les commandes")
    async def shelp(self, ctx: SlashContext):
        await ctx.send(embeds=[shelp])
